    ...
    <main className="max-w-7xl mx-auto px-4 py-8" aria-busy="true" aria-label="Loading site settings">
      ...
      <div className="flex gap-6 items-start">
        <div className="w-80 shrink-0 space-y-4">
          <div className="mb-4 flex flex-col gap-2">
            <div className="flex items-center gap-2">
              <div className="h-9 w-[8.25rem] shrink-0 rounded-md border border-neutral-200 bg-neutral-100/80 animate-pulse dark:border-neutral-700" />
            </div>
            <div className="h-9 w-full rounded border border-neutral-200 bg-neutral-50 animate-pulse dark:border-neutral-700 dark:bg-neutral-900" />
          </div>
          <div className="p-4 border border-neutral-100 rounded-lg space-y-3 dark:border-neutral-800">
            <div className="h-3 w-16 rounded bg-neutral-100 animate-pulse dark:bg-neutral-800" />
            <div className="grid grid-cols-2 gap-3">
              {[0, 1, 2, 3].map((i) => (
                <div key={i} className="space-y-1.5">
                  <div className="h-3 w-12 rounded bg-neutral-50 animate-pulse dark:bg-neutral-900" />
        ...
        <div className="flex-1 min-w-0">
          <div className="border border-neutral-200 rounded-lg overflow-hidden bg-white sticky top-8 dark:border-neutral-700 dark:bg-neutral-900">
            <div className="flex items-center gap-1.5 px-3 py-2 border-b border-neutral-100 bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-900">
              <div className="w-2 h-2 rounded-full bg-neutral-200 animate-pulse" />
              <div className="w-2 h-2 rounded-full bg-neutral-200 animate-pulse" />
              <div className="w-2 h-2 rounded-full bg-neutral-200 animate-pulse" />
              <div className="h-2.5 flex-1 max-w-48 ml-2 rounded bg-neutral-100 animate-pulse dark:bg-neutral-800" />
            </div>
            <div
